        ...
        <div className="invitation-container">
            <div className="invitation-card">
                ...
                <div className="invitation-header">
                    ...
                    >
                        Аяулы қызымыз <span className="highlight">Арайдың</span> ата-анасының аялы алақанынан –
                        құтты босағасына шығарып салу рәсіміне арналған салтанатты дастарханымыздың қадірлі қонағы болуға шақырамыз!
                    </motion.p>
                </div>
                ...
                <motion.div
                    ...
                    className="hosts"
                >
                    <p className="hosts-label">Той иелері</p>
                    <p className="hosts-names">Арман – Айгүл</p>
                ...
                <div className="main-content">
                    ...
                    >
                        <p className="date-label">Күні:</p>
                        <h2 className="date-value">4 Qazan 18.00</h2>
                    ...
                    >
                        <p className="location-label">Орны:</p>
